...
namespace SDP.Controllers
{
    public class CustomerController : Controller
    {
        ...
        [HttpGet]
        [Authorize]
        public IActionResult CustomerList(string search)
        {
        ...
        public ActionResult MailInvoice() {
            ...
            //Console.WriteLine(email);
            //var senderEmail = new MailAddress("palh.5515@gmail.com", "Harshit pal");
            ...
            string from = "palh5515@gmail.com"; //From address    
            ...
            System.Net.NetworkCredential("palh5515@gmail.com", "");
